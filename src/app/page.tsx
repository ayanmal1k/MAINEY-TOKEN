      ...
      <div className="relative z-20 container mx-auto px-6 py-12 md:py-24 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-screen">
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center text-center lg:pr-6 z-10">
          ...
          <motion.p
            ...
            className="text-[#FEF3C7] font-kiro font-black text-xs md:text-sm tracking-widest uppercase mb-10 max-w-xl filter drop-shadow-[0_3px_5px_rgba(0,0,0,0.8)]"
          >
          ...
          >
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="relative overflow-hidden px-5 md:px-10 py-4 rounded-xl bg-gradient-to-b from-[#34622b] via-[#284b21] to-[#1c3617] border border-[#d4af37]/80 hover:border-[#ffd700] text-[#FEF3C7] font-kiro font-black text-sm md:text-lg tracking-widest uppercase flex items-center justify-center cursor-pointer shadow-[0_6px_20px_rgba(40,75,33,0.5)] transition-all duration-300 w-[48%] md:w-auto whitespace-nowrap group"
            >
            ...
            <motion.button 
              whileHover={{ scale: 1.04, boxShadow: "0 0 25px rgba(254, 243, 199, 0.15)" }}
              whileTap={{ scale: 0.98 }}
              className="relative overflow-hidden px-5 md:px-10 py-4 rounded-xl bg-gradient-to-b from-[#121c15]/90 via-[#0a110b]/95 to-[#030604]/98 border border-[#FEF3C7]/30 hover:border-[#FEF3C7]/85 text-[#FEF3C7] font-kiro font-black text-sm md:text-lg tracking-widest uppercase flex items-center justify-center cursor-pointer transition-all duration-300 w-[48%] md:w-auto whitespace-nowrap group"
            >
          ...
          <div className="relative w-[260px] h-[720px] lg:w-full lg:max-w-6xl lg:h-[160px] mx-auto flex items-center justify-center">
            ...
            <div className="relative z-10 w-full h-full flex flex-col lg:flex-row items-center justify-around py-12 lg:py-0 px-4 lg:px-8">
              ...
              >
                ...
                <p className="text-[#FEF3C7] font-kiro font-bold text-xs lg:text-sm tracking-wide mt-0.5 filter drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                  No Presale
                </p>
              ...
              >
                ...
                <p className="text-[#FEF3C7] font-kiro font-bold text-xs lg:text-sm tracking-wide mt-0.5 whitespace-nowrap filter drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                  0% Buy / 0% Sell
                </p>
                <div className="hidden lg:block absolute right-0 top-1/4 bottom-1/4 w-[1px] bg-[#3a200a]/50" />
              </motion.div>
